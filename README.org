...
*** Paper Wallets for Software Wallet Support
    ...
    #+RESULTS:
    : 2023-09-20 15:35:21 slip39           It is recommended to not use '-s|--secret <hex>'; specify '-' to read from input
    : 2023-09-20 15:35:21 slip39           It is recommended to not use '-w|--wallet <password>'; specify '-' to read from input
    : 2023-09-20 15:35:21 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0x824b174803e688dE39aF5B3D7Cd39bE6515A19a1
    : 2023-09-20 15:35:21 slip39.layout    BTC    m/84'/0'/0'/0/0     : bc1q9yscq3l2yfxlvnlk3cszpqefparrv7tk24u6pl
    : 2023-09-20 15:35:21 slip39.layout    DOGE   m/44'/3'/0'/0/0     : DN8PNN3dipSJpLmyxtGe4EJH38EhqF8Sfy
    : 2023-09-20 15:35:21 slip39.layout    LTC    m/84'/2'/0'/0/0     : ltc1qe5m2mst9kjcqtfpapaanaty40qe8xtusmq4ake
    : 2023-09-20 15:35:24 slip39.layout    Writing SLIP39-encoded wallet for 'SLIP39' to: SLIP39-2023-09-20+15.35.21-ETH-0x824b174803e688dE39aF5B3D7Cd39bE6515A19a1.pdf
    ...
    #+RESULTS:
    : 2023-09-20 15:35:02 slip39.recovery  Recovered 128-bit SLIP-39 Seed Entropy with 2 (all) of 2 supplied mnemonics; Seed decoded from SLIP-39 Mnemonics w/ no passphrase
    : 2023-09-20 15:35:02 slip39.recovery  Recovered SLIP-39 secret; To re-generate SLIP-39 wallet, send it to: python3 -m slip39 --secret -
    ...
    #+RESULTS:
    : 2023-09-20 15:34:51 slip39           It is recommended to not use '-w|--wallet <password>'; specify '-' to read from input
    : 2023-09-20 15:34:51 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0x824b174803e688dE39aF5B3D7Cd39bE6515A19a1
    : 2023-09-20 15:34:51 slip39.layout    BTC    m/84'/0'/0'/0/0     : bc1q9yscq3l2yfxlvnlk3cszpqefparrv7tk24u6pl
    : 2023-09-20 15:34:51 slip39.layout    DOGE   m/44'/3'/0'/0/0     : DN8PNN3dipSJpLmyxtGe4EJH38EhqF8Sfy
    : 2023-09-20 15:34:51 slip39.layout    LTC    m/84'/2'/0'/0/0     : ltc1qe5m2mst9kjcqtfpapaanaty40qe8xtusmq4ake
    : 2023-09-20 15:34:54 slip39.layout    Writing SLIP39-encoded wallet for 'SLIP39' to: SLIP39-2023-09-20+15.34.52-ETH-0x824b174803e688dE39aF5B3D7Cd39bE6515A19a1.pdf
...
** Recovery & Re-Creation
  ...
  #+RESULTS:
  : 2023-09-20 15:34:33 slip39           It is recommended to not use '-s|--secret <hex>'; specify '-' to read from input
  : 2023-09-20 15:34:33 slip39           It is recommended to not use '-w|--wallet <password>'; specify '-' to read from input
  : 2023-09-20 15:34:33 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0xb44A2011A99596671d5952CdC22816089f142FB3
  : 2023-09-20 15:34:33 slip39.layout    BTC    m/84'/0'/0'/0/0     : bc1qcupw7k8enymvvsa7w35j5hq4ergtvus3zk8a8s
  : 2023-09-20 15:34:35 slip39.layout    Writing SLIP39-encoded wallet for 'SLIP39' to: SLIP39-2023-09-20+15.34.34-ETH-0xb44A2011A99596671d5952CdC22816089f142FB3.pdf
...
*** Pipelining =slip39.recovery | slip39 --secret -=
   ...
   #+RESULTS:
   : 2023-09-20 15:34:12 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0x8edACCa26Cc3536A78B1B7bfc2fF124214AAdfcB
   : 2023-09-20 15:34:12 slip39.layout    BTC    m/84'/0'/0'/0/0     : bc1q4m7n9pfd2l7xzz6w9fl60dlr93t0cdeac5pxkp
...
:END:
    ...
    : 
    : 
    : nonce: bcf054e8e5af71e0b61f62770704b893e0ec7c1b749ea24bb607c234
    :     0: e5f574f1261287a5c106fb82582d44f9b7eb7f4ee2c60b2a7d6c6c3dc2d6878395f5146ec1cbbeea2bc67dbdf62e7...
    :     1: ccbcb08653a7ce06893c4f60f21ebbd22b2388726461f155e7903628aee6c63294170dc7deb91093307227946257c...
    :     2: 0310707354f3c19556d0ff5e3fd008e2bcc16956a55724cd71e875ba7916a1926c384764a8ad5fc85a181b49b08f0...
    :     3: 87d01d40703a203a03bf8847902b1a3ba682cdcb3837947192263962057189ee511343ce15f5cb021fe125fc1c53e...
...
:END:
    ...
    #+RESULTS:
    : 2023-09-19 05:43:28 slip39.generator Decrypting accountgroups with nonce: e1c1cabfe65b0b0cde555b93
    ...
    #+RESULTS:
    #+begin_example
    2023-09-19 05:43:30 slip39.generator Decrypting accountgroups with nonce: 76ad9b751f8da1ffa68e6f21
    --- 0
    ...
    #+RESULTS:
    #+begin_example
    2023-09-19 05:43:31 slip39.generator Decrypting accountgroups with nonce: ca20c03523d27fa25cd7ebfd
    --- 0
...
*** Emergency Recovery: Using Recovered Paper Wallets
    ...
    #+END_SRC
    #+RESULTS:
    : 2023-09-19 05:44:02 slip39.recovery  BIP-39 Language detected: english
    : 2023-09-19 05:44:02 slip39.recovery  Recovered 512-bit BIP-39 secret from english mnemonic
    : 2023-09-19 05:44:02 slip39.recovery  Recovered BIP-39 secret; To re-generate SLIP-39 wallet, send it to: python3 -m slip39 --secret -
    ...
    #+RESULTS:
    #+begin_example
    2023-09-19 05:44:03 slip39                7 scandal   19 alto      31 starting  43 dance     55 garden    
    2023-09-19 05:44:03 slip39                8 forward   20 snapshot  32 memory    44 aunt      56 script    
    2023-09-19 05:44:03 slip39                9 research  21 eraser    33 plot      45 glasses   57 senior    
    2023-09-19 05:44:03 slip39               10 laser     22 elephant  34 listen    46 result    58 material  
    2023-09-19 05:44:03 slip39               11 answer    23 dream     35 destroy   47 method    59 always    
    2023-09-19 05:44:03 slip39               12 fancy     24 victim    36 liquid    48 scroll    
    2023-09-19 05:44:03 slip39           6th  1 kind      13 rapids    25 squeeze   37 ranked    49 maiden    
    2023-09-19 05:44:03 slip39                2 regret    14 clinic    26 knife     38 inherit   50 mobile    
    2023-09-19 05:44:03 slip39                3 decision  15 royal     27 sled      39 music     51 furl      
    2023-09-19 05:44:03 slip39                4 spider    16 plastic   28 rebuild   40 disease   52 antenna   
    2023-09-19 05:44:03 slip39                5 acid      17 switch    29 coding    41 industry  53 pencil    
    2023-09-19 05:44:03 slip39                6 burden    18 answer    30 divorce   42 herald    54 jerky     
    2023-09-19 05:44:03 slip39                7 single    19 climate   31 mason     43 warn      55 silent    
    2023-09-19 05:44:03 slip39                8 aviation  20 webcam    32 domestic  44 fumes     56 trash     
    2023-09-19 05:44:03 slip39                9 brave     21 indicate  33 scatter   45 goat      57 stilt     
    2023-09-19 05:44:03 slip39               10 should    22 diet      34 chemical  46 staff     58 tadpole   
    2023-09-19 05:44:03 slip39               11 genuine   23 election  35 pleasure  47 smug      59 decision  
    2023-09-19 05:44:03 slip39               12 behavior  24 unknown   36 very      48 advocate  
    2023-09-19 05:44:03 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0xfc2077CA7F403cBECA41B1B0F62D91B5EA631B5
    2023-09-19 05:44:11 slip39                7 smirk     14 daughter  
    2023-09-19 05:44:11 slip39           6th  1 laden      8 column    15 legal     
    2023-09-19 05:44:11 slip39                2 training   9 glance    16 marathon  
    2023-09-19 05:44:11 slip39                3 decision  10 obesity   17 fortune   
    2023-09-19 05:44:11 slip39                4 spider    11 painting  18 mailman   
    2023-09-19 05:44:11 slip39                5 cards     12 lift      19 exotic    
    2023-09-19 05:44:11 slip39                6 devote    13 argue     20 hybrid    
    2023-09-19 05:44:11 slip39                7 rhythm    14 alcohol   
    2023-09-19 05:44:11 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0xfc2077CA7F403cBECA41B1B0F62D91B5EA631B5E
    2023-09-19 05:44:11 slip39.layout    BTC    m/84'/0'/0'/0/0     : bc1qk0a9hr7wjfxeenz9nwenw9flhq0tmsf6vsgnn2
    #+end_example
    #+LATEX: }
...
import slip39
from slip39.invoice import MultiPayoutERC20, ethereum

goerli_xprvkey                  = os.getenv( 'GOERLI_XPRVKEY' )
if not goerli_xprvkey:
    goerli_seed                 = os.getenv( 'GOERLI_SEED' )
    #goerli_seed                 = "zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo wrong"
...
if goerli_xprvkey:
    ...
    if contract:
        print("MultiPayoutERC20 Pre-defined Contract Details:")
        print( tabulate( [
     ...
     #+RESULTS:
     :results:
     Using Ethereum seed: zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo wrong
     Using Ethereum address: ETH: 0x667AcC3Fc27A8EbcDA66E7E01ceCA179d407ce00
     MultiPayoutERC20 Payees:
	 | Payee                                      | Share                 |   Frac. % |   Reserve |   Reserve/2^16 |   Frac.Rec. % |   Error % |
	 |--------------------------------------------+-----------------------+-----------+-----------+----------------+---------------+-----------|
	 | 0x7Fc431B8FC8250A992567E3D7Da20EE68C155109 | 10923/65536           |   16.6672 |     54613 |          54613 |       16.6672 |         0 |
	 | 0xE5714055437154E812d451aF86239087E0829fA8 | 1431679795/4294967296 |   33.3339 |     39321 |          39321 |       33.3339 |         0 |
	 | 0xEeC2b464c2f50706E3364f5893c659edC9E4153A | 2147437773/4294967296 |   49.9989 |         0 |              0 |       49.9989 |         0 |
     ERC-20s:
	 | Token                                      | Symbol   |   Digits |
	 |--------------------------------------------+----------+----------|
     ...
     Contract 0xbe69793974fc55cd8b94dac6b410827740cc6d68 IS a MultiPayoutERC20
     MultiPayoutERC20 Pre-defined Contract Details:
     | MultiPayoutERC20 Contract: | 0xbe69793974fc55cd8b94dac6b410827740cc6d68 |
     :end:
     #+LATEX: }
...
if not contract:
    ...
    print( f"No attempt to create a MultiPayoutERC20; using pre-defined: {contract}" )
...
print("MultiPayoutERC20 Contract & Forwarder Details:")
print( tabulate( [
    [ "MultiPayoutERC20 Contract:", f"{contract}" ],
    ...
    | MultiPayoutERC20 Contract: | 0xbe69793974fc55cd8b94dac6b410827740cc6d68                       |
    | Unique Client Salt:        | 51d1e0102d71e7e82716508803a7de708eb10b70a6640c645b0cfd9faa67e271 |
    | Their Forwarder Contract:  | 0xEdBfA89a4B3d2B9b7CACcF235C3C5559555f5ee0                       |
    :end:
    #+LATEX: }
