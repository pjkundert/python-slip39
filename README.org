...
slip39 --secret "seven replace great luggage fox rent general tower guess inside smile sing"
   ...
   #+RESULTS:
   :results:
   SLIP39-2025-11-22+14.18.44-ETH-0x6E6268F14B922cb924C7683A415B30C2bf967000.pdf
   :end:
...
* Security with Availability
  ...
  sequence of Ethereum and Bitcoin Hierarchical Deterministic (HD) derived Wallet accounts.  Anyone
...
slip39 -c ETH -c BTC -c DOGE -c LTC --secret ffffffffffffffffffffffffffffffff \
    ...
    #+RESULTS:
    : 2025-11-22 14:55:22 slip39           It is recommended to not use '-s|--secret <hex>'; specify '-' to read from input
    : 2025-11-22 14:55:22 slip39           It is recommended to not use '-w|--wallet <password>'; specify '-' to read from input
    : 2025-11-22 14:55:22 slip39           Generated 128-bit SLIP-39 Mnemonics w/ identifier 28084 requiring 2 of 4 (extendable) groups to recover
    : 2025-11-22 14:55:22 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0x824b174803e688dE39aF5B3D7Cd39bE6515A19a1
    : 2025-11-22 14:55:22 slip39.layout    BTC    m/84'/0'/0'/0/0     : bc1q9yscq3l2yfxlvnlk3cszpqefparrv7tk24u6pl
    : 2025-11-22 14:55:22 slip39.layout    DOGE   m/44'/3'/0'/0/0     : DN8PNN3dipSJpLmyxtGe4EJH38EhqF8Sfy
    : 2025-11-22 14:55:22 slip39.layout    LTC    m/84'/2'/0'/0/0     : ltc1qe5m2mst9kjcqtfpapaanaty40qe8xtusmq4ake
    : 2025-11-22 14:55:25 slip39.layout    Writing SLIP39-encoded wallet for 'SLIP39' to: SLIP39-2025-11-22+14.55.24-ETH-0x824b174803e688dE39aF5B3D7Cd39bE6515A19a1.pdf
...
slip39-recovery -v \
    ...
    #+RESULTS:
    : 2025-11-22 14:55:53 slip39.recovery  Recovered 128-bit Encrypted SLIP-39 Seed Entropy using 2 groups comprising 2 mnemonics
    : 2025-11-22 14:55:53 slip39.recovery  Seed decoded from SLIP-39 Mnemonics w/ no passphrase
    : 2025-11-22 14:55:53 slip39.recovery  Recovered SLIP-39 secret; To re-generate SLIP-39 wallet, send it to: python3 -m slip39 --secret -
...
| slip39 -c ETH -c BTC -c DOGE -c LTC --secret - \
    ...
    #+RESULTS:
    : 2025-11-22 14:56:05 slip39           It is recommended to not use '-w|--wallet <password>'; specify '-' to read from input
    : 2025-11-22 14:56:05 slip39           Generated 128-bit SLIP-39 Mnemonics w/ identifier 4224 requiring 2 of 4 (extendable) groups to recover
    : 2025-11-22 14:56:05 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0x824b174803e688dE39aF5B3D7Cd39bE6515A19a1
    : 2025-11-22 14:56:05 slip39.layout    BTC    m/84'/0'/0'/0/0     : bc1q9yscq3l2yfxlvnlk3cszpqefparrv7tk24u6pl
    : 2025-11-22 14:56:05 slip39.layout    DOGE   m/44'/3'/0'/0/0     : DN8PNN3dipSJpLmyxtGe4EJH38EhqF8Sfy
    : 2025-11-22 14:56:05 slip39.layout    LTC    m/84'/2'/0'/0/0     : ltc1qe5m2mst9kjcqtfpapaanaty40qe8xtusmq4ake
    : 2025-11-22 14:56:08 slip39.layout    Writing SLIP39-encoded wallet for 'SLIP39' to: SLIP39-2025-11-22+14.56.07-ETH-0x824b174803e688dE39aF5B3D7Cd39bE6515A19a1.pdf
...
**** Other HDWallet support cryptocurrencies
     ...
     Any other cryptocurrency supported by HDWallet is available (so long as it supports BIP44, and
     are also considered Beta quality.
...
slip39 --secret 383597fd63547e7c9525575decd413f7 --wallet password --wallet-hint bad:pass... 2>&1
  ...
  #+RESULTS:
  : 2025-11-22 14:56:40 slip39           It is recommended to not use '-s|--secret <hex>'; specify '-' to read from input
  : 2025-11-22 14:56:40 slip39           It is recommended to not use '-w|--wallet <password>'; specify '-' to read from input
  : 2025-11-22 14:56:40 slip39           Generated 128-bit SLIP-39 Mnemonics w/ identifier 14408 requiring 2 of 4 (extendable) groups to recover
  : 2025-11-22 14:56:40 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0xb44A2011A99596671d5952CdC22816089f142FB3
  : 2025-11-22 14:56:40 slip39.layout    BTC    m/84'/0'/0'/0/0     : bc1qcupw7k8enymvvsa7w35j5hq4ergtvus3zk8a8s
  : 2025-11-22 14:56:43 slip39.layout    Writing SLIP39-encoded wallet for 'SLIP39' to: SLIP39-2025-11-22+14.56.42-ETH-0xb44A2011A99596671d5952CdC22816089f142FB3.pdf
  : SLIP39-2025-11-22+14.56.42-ETH-0xb44A2011A99596671d5952CdC22816089f142FB3.pdf
...
( python3 -m slip39 --text --no-card \
   ...
   #+RESULTS:
   : 2025-11-22 14:57:14 slip39           Generated 128-bit SLIP-39 Mnemonics w/ identifier 6037 requiring 2 of 4 (extendable) groups to recover
   : 2025-11-22 14:57:14 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0x4240cF80a18790C161783c2686c64F53CCd7a02E
   ...
   : 2025-11-22 14:57:14 slip39           Generated 128-bit SLIP-39 Mnemonics w/ identifier 13225 requiring 2 of 4 (extendable) groups to recover
   : 2025-11-22 14:57:14 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0x4240cF80a18790C161783c2686c64F53CCd7a02E
   : 2025-11-22 14:57:14 slip39.layout    BTC    m/84'/0'/0'/0/0     : bc1qsll7nfaa2xcmuyykfsz0w4lrq6p3au6aq2tqns
...
( python3 -m slip39.recovery --bip39 --entropy \
    ...
    #+RESULTS:
    : 2025-11-22 14:57:23 slip39           Assuming BIP-39 seed entropy: Ensure you recover and use via a BIP-39 Mnemonic
    : 2025-11-22 14:57:23 slip39           Generated 128-bit SLIP-39 Mnemonics w/ identifier 8676 requiring 2 of 4 (extendable) groups to recover
    : 2025-11-22 14:57:23 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0xfc2077CA7F403cBECA41B1B0F62D91B5EA631B5E
    : 2025-11-22 14:57:23 slip39.layout    BTC    m/84'/0'/0'/0/0     : bc1qk0a9hr7wjfxeenz9nwenw9flhq0tmsf6vsgnn2
    : 2025-11-22 14:57:25 slip39.layout    Writing SLIP39 backup for BIP-39-encoded wallet for 'SLIP39' to: SLIP39-2025-11-22+14.57.25-ETH-0xfc2077CA7F403cBECA41B1B0F62D91B5EA631B5E.pdf
    : SLIP39-2025-11-22+14.57.25-ETH-0xfc2077CA7F403cBECA41B1B0F62D91B5EA631B5E.pdf
...
( slip39-recovery --bip39 --mnemonic 'zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo wrong' \
    ...
    : 
    : 
    : nonce: 6adebead989ad33697f6b016b94ea579f468c05224fd036dab5f1029
    :     0: 5d4c3a90b621b89e8833b763b004d459c2cb6cc09c9d0884a1a4e4e144e750597609d8f2950203524ecea344879e6...
    :     1: e5b4bece96d4616688db6127fdf86cbe5dcfab0ddf9e2ac6f461ecf65480e19299408c619c8adf817f93bf14a5216...
    :     2: 7272a33c726446d1f504a4b20dfb0695323ac43469b7c1836a87649e7d31b458548f09f5e0bab4793d136ab665f5d...
...
( echo 'zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo wrong' \
    ...
    #+RESULTS:
    : 2025-11-22 14:59:27 slip39.generator Decrypting accountgroups with nonce: a5bfaea303c5faf3b79306f6
...
( echo 'zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo wrong' \
    ...
    #+RESULTS:
    #+begin_example
    2025-11-22 14:59:54 slip39.generator Decrypting accountgroups with nonce: 6b30ea6d946ca3753874fd67
    --- 0
...
( echo 'zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo wrong' \
    ...
    #+RESULTS:
    #+begin_example
    2025-11-22 14:59:58 slip39.generator Decrypting accountgroups with nonce: 41c206de454d4a87f0b9a224
    --- 0
...
[
    ...
    #+RESULTS:
    | Valid random 12-word mnemonics: |    6.06% |
    | Or, about:                      | 1 / 16.5 |
    #+LATEX: }
...
( python3 -m slip39.recovery --bip39 -v \
    ...
    #+END_SRC
    #+RESULTS:
    : 2025-11-22 15:05:52 slip39.recovery  BIP-39 Language detected: english
    : 2025-11-22 15:05:52 slip39.recovery  Recovered 512-bit BIP-39 secret from english mnemonic
    : 2025-11-22 15:05:52 slip39.recovery  Recovered BIP-39 secret; To re-generate SLIP-39 wallet, send it to: python3 -m slip39 --secret -
...
( python3 -m slip39.recovery --bip39 \
  ...
  | python3 -m slip39 --secret - --no-card -v
    ...
    #+RESULTS:
    #+begin_example
    2025-11-22 15:05:56 slip39                7 nylon     19 merchant  31 drug      43 spend     55 watch     
    2025-11-22 15:05:56 slip39                8 require   20 orange    32 drift     44 civil     56 listen    
    2025-11-22 15:05:56 slip39                9 solution  21 agree     33 idea      45 kernel    57 romantic  
    2025-11-22 15:05:56 slip39               10 senior    22 smith     34 modify    46 false     58 much      
    2025-11-22 15:05:56 slip39               11 document  23 rebuild   35 timber    47 herald    59 coding    
    2025-11-22 15:05:56 slip39               12 email     24 presence  36 wisdom    48 best      
    2025-11-22 15:05:56 slip39           6th  1 regret    13 slow      25 sweater   37 triumph   49 numerous  
    2025-11-22 15:05:56 slip39                2 penalty   14 silver    26 genre     38 result    50 spirit    
    2025-11-22 15:05:56 slip39                3 decision  15 greatest  27 demand    39 display   51 detailed  
    2025-11-22 15:05:56 slip39                4 spider    16 drove     28 venture   40 advance   52 picture   
    2025-11-22 15:05:56 slip39                5 acne      17 voting    29 voter     41 romantic  53 mule      
    2025-11-22 15:05:56 slip39                6 patent    18 priority  30 punish    42 dismiss   54 fiction   
    2025-11-22 15:05:56 slip39                7 index     19 makeup    31 counter   43 capture   55 adult     
    2025-11-22 15:05:56 slip39                8 extra     20 repeat    32 flexible  44 group     56 domestic  
    2025-11-22 15:05:56 slip39                9 syndrome  21 harvest   33 adult     45 champion  57 forbid    
    2025-11-22 15:05:56 slip39               10 crisis    22 yelp      34 multiple  46 holiday   58 lobe      
    2025-11-22 15:05:56 slip39               11 intend    23 similar   35 velvet    47 fatigue   59 tactics   
    2025-11-22 15:05:56 slip39               12 climate   24 merchant  36 square    48 lungs     
    2025-11-22 15:05:56 slip39.layout    ETH    m/44'/60'/0'/0/0    : 0xfc2077CA7F403cBECA41B1B0F62D91B5EA631B5E
    2025-11-22 15:05:56 slip39.layout    BTC    m/84'/0'/0'/0/0     : bc1qk0a9hr7wjfxeenz9nwenw9flhq0tmsf6vsgnn2
    #+end_example
    #+LATEX: }
...
( python3 -m slip39.recovery --bip39 --entropy -v \
    ...
    #+END_SRC
    #+RESULTS:
    : 2025-11-22 15:06:07 slip39.recovery  BIP-39 Language detected: english
    : 2025-11-22 15:06:07 slip39.recovery  Recovered 128-bit BIP-39 entropy from english mnemonic (no passphrase supported)
    : 2025-11-22 15:06:07 slip39.recovery  Recovered BIP-39 secret; To re-generate SLIP-39 wallet, send it to: python3 -m slip39 --secret -
